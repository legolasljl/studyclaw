...
// // 		log.Infof("当前有更新的 studyclaw 可供更新, 请前往 https://github.com/legolasljl/studyclaw/releases 下载.")
...
// 	response, err := http.Get("https://api.github.com/repos/sjkhsl/studyclaw/releases/latest")
// 	if err != nil {
// 		return "", err
// 	}
...
// 		ext = "zip"
// 	}
// 	return fmt.Sprintf("studyclaw_%v_%v.%v", runtime.GOOS, goarch, ext)
// }

// func checksum(github, version string) []byte {
// 	sumURL := fmt.Sprintf("%v/sjkhsl/studyclaw/releases/download/%v/studyclaw_checksums.txt", github, version)
...
// // 		wait()
// // 	}
// // 	url := fmt.Sprintf("%v/sjkhsl/studyclaw/releases/download/%v/%v", github, latest, binaryName())
// // 	if version == latest {
