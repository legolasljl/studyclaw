...
var (
	dbSum = "eda62aa3a39cfc2c58cf4fb67863cc9ecab7b689a2fc196f787217a017d75877"
)
...
func DownloadDbFile() {
	...
	response, err := http.Get("https://github.com/legolasljl/studyclaw/releases/download/v1.0.39/QuestionBank.db")
	if err != nil {
