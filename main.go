...
import (
	...
	"github.com/legolasljl/studyclaw/utils/stop"
	...
	// "github.com/legolasljl/studyclaw/gui"
	"github.com/legolasljl/studyclaw/lib"
	"github.com/legolasljl/studyclaw/model"
	"github.com/legolasljl/studyclaw/push"

	// "github.com/legolasljl/studyclaw/utils/update"
	"github.com/legolasljl/studyclaw/web"
)
...
func init() {
	...
	if !utils.CheckQuestionDB() {
		...
		//log.Errorln("题库文件不存在或已损坏，请手动前往 https://github.com/legolasljl/studyclaw/blob/main/conf/QuestionBank.db 下载并放入程序根目录")
	}
}

func shouldRunInBackground() bool {
	if runtime.GOOS == "windows" {
		return false
	}
	if os.Getenv("STUDYCLAW_DISABLE_BACKGROUND") == "1" {
		return false
	}
